...
require_once 'Japanyard_Error.php';
require_once 'Japanyard_ActionClass.php';
require_once 'Japanyard_ActionForm.php';
require_once 'Japanyard_ViewClass.php';
require_once BASE . '/app/bootstrap.php';

/**
 *  Japanyard application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Japanyard
 */
class Japanyard_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
    ...
    var $forward = array(
         ...
         *
         *  'index'         => array(
         *      'view_name' => 'Japanyard_View_Index',
         *  ),
         */
    );
    ...
    var $class = array(
        ...
        'form'          => 'Japanyard_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Japanyard_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Japanyard_UrlHandler',
    );
    ...
    var $plugin_search_appids = array(
         ...
         *  2. Japanyard_Plugin_Foo_Bar
         *  3. Ethna_Plugin_Foo_Bar
         *
         *  'Common', 'Japanyard', 'Ethna',
         */
        'Japanyard', 'Ethna',
    );
